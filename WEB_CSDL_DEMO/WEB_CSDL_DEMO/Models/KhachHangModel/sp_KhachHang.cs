...
{
    public class sp_KhachHang
    {
        string connectionString = "data source=192.168.1.4,1433;initial catalog=fashionDatabase;persist security info=True;user id=sa;password=Duytran260202#;";
        ...
        public void ThemKhachHang(KhachHang model)
        {
