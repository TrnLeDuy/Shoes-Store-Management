...
GO
/****** Object:  Database [fashionDatabase]    Script Date: 5/12/2023 8:30:00 PM ******/
...
USE [fashionDatabase]
GO
/****** Object:  Table [dbo].[CHUCVU]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CTDONHANG]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CTHOADON]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CTPHIEUMUAHANG]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[CTPHIEUMUAHANG](
	[MaCTPMH] [int] NOT NULL,
	[MaPMH] [char](10) NOT NULL,
	[MaSP] [char](10) NOT NULL,
	[SoLuong] [int] NULL,
	[DonGia] [numeric](18, 0) NULL,
	[KichCo] [char](10) NULL,
	[TenLoaiSP] [nvarchar](100) NULL,
 CONSTRAINT [PK_CTPHIEUMUAHANG] PRIMARY KEY CLUSTERED 
(
	[MaCTPMH] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[DONHANG]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[HOADON]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[KHACHHANG]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[KICHCOSP]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LOAISANPHAM]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NHACUNGCAP]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NHANVIEN]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PHIEUMUAHANG]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PHONGBAN]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SANPHAM]    Script Date: 5/12/2023 8:30:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[CTPHIEUMUAHANG]  WITH CHECK ADD  CONSTRAINT [FK_CTPHIEUMUAHANG_PHIEUMUAHANG] FOREIGN KEY([MaPMH])
REFERENCES [dbo].[PHIEUMUAHANG] ([MaPMH])
GO
ALTER TABLE [dbo].[CTPHIEUMUAHANG] CHECK CONSTRAINT [FK_CTPHIEUMUAHANG_PHIEUMUAHANG]
GO
ALTER TABLE [dbo].[CTPHIEUMUAHANG]  WITH CHECK ADD  CONSTRAINT [FK_CTPHIEUMUAHANG_SANPHAM] FOREIGN KEY([MaSP])
REFERENCES [dbo].[SANPHAM] ([MaSP])
GO
ALTER TABLE [dbo].[CTPHIEUMUAHANG] CHECK CONSTRAINT [FK_CTPHIEUMUAHANG_SANPHAM]
GO
...
GO
ALTER TABLE [dbo].[PHIEUMUAHANG]  WITH CHECK ADD  CONSTRAINT [FK_PHIEUMUAHANG_NHACUNGCAP] FOREIGN KEY([MaNCC])
REFERENCES [dbo].[NHACUNGCAP] ([MaNCC])
GO
ALTER TABLE [dbo].[PHIEUMUAHANG] CHECK CONSTRAINT [FK_PHIEUMUAHANG_NHACUNGCAP]
GO
